...
<html lang="en">
    ...
    <title>BuoyAccessories</title>
  </head>
	<body id="body">
    <div id="nav">  
      <ul>    
        <li><a href="buoyAccessories.php" id="mybuoynav">MyBuoy</a></li>
    ...
    <h1>BuoyAccessories:</h1>
    <div id="buoy_header">
        <img src="buoyIcon.png" alt="Buoy" width="50" height="50">
    </div> 
<div id="create_new_button">
<a href="createAccessories.html">create new listing</a>
</div>
...
<h2>Current listings: </h2>
    ...
    $query = "SELECT * FROM `elec_accessories`";
